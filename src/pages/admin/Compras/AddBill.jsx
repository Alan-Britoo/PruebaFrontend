...
function AddBill() {
  ...
  useEffect(() => {
    fetch("https://pruebabackend-production-d725.up.railway.app/api/producto")
      .then((res) => res.json())
      .then((dataProducto) => {
  ...
  useEffect(() => {
    fetch("https://pruebabackend-production-d725.up.railway.app/api/proveedore")
      .then((res) => res.json())
      .then((dataProveedor) => {
  ...
  const handleSubmit = async (e) => {
    ...
    fetch("https://pruebabackend-production-d725.up.railway.app/api/compra", {
      method: "POST",
